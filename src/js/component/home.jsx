...
const Home = (props) => {
	...
	return (
		...
		<div className="maindiv" style={mainStyle}>
			...
			<div className="firstnumber" style={numbersStyle}><h1>{props.None % 10}</h1></div>
			<div className="secondnumber" style={numbersStyle}><h1>{props.Ntwo % 10}</h1></div>
			<div className="thirdnumber" style={numbersStyle}><h1>{props.Nthree % 10}</h1></div>
			<div className="fourthnumber" style={numbersStyle}><h1>{props.Nfour % 10}</h1></div>
			<div className="fifthnumber" style={numbersStyle}><h1>{props.Nfive % 10}</h1></div>
		</div>
